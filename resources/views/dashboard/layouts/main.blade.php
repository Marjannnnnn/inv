    ...
    <div id="app">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                <form class="form-inline mr-auto">
                    <ul class="navbar-nav mr-3 navbar-left">
                        ...
                        <h5 class="text-success rounded p-2">Selamat Datang
                            {{ ucfirst(auth()->user()->role) }}</h5>
                    </ul>
                </form>
            </nav>
                ...
                <aside id="sidebar-wrapper">
                    <ul class="sidebar-menu">
                        ...
                        @if (auth()->user()->role == 'admin')
                            <li class="nav-item dropdown">
                                <a href="{{ route('category.index') }}"><i class="fas fa-bars"></i>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="nav-link" href="{{ route('dashboard.accounts.admin') }}">
                                            Admin</a>
                                    </li>
                                    <li><a class="nav-link" href="{{ route('dashboard.accounts.operator') }}">
                                            Operator</a></li>
                                </ul>
                            </li>
                        @elseif(auth()->user()->role == 'operator')
                            <li class="nav-item dropdown">
                                <a href="{{ route('dashboard.operator.item.index') }}"><i
                                        class="fas fa-window-restore"></i> <span>Items</span></a>
                            </li>
                            <li class="nav-item dropdown">
                                <a href="{{ route('dashboard.operator.lending.index') }}"><i
                                        class="fas fa-spinner"></i> <span>Lending</span></a>
                            </li>
                        @endif
                    </ul>
                </aside>
        ...
        <footer class="main-footer">
            <div class="footer-left">
                Copyright &copy; 2023 <div class="bullet"><a>Kevin Yardan Fauzan</a></div>
            </div>
        </footer>
    </div>
    </div>
